...
{%- for ch_name, ch in asyncapi.channels() -%}
	...
	// {{opName}} publishes a {{msgName}} message to the transport implementation using the
	// params provided in the param.{{opName}}Params. It is bound to the following channel operation:
	//
	// PUBLISH: {{ch_name}} 
